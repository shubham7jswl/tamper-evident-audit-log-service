 ...
 *
 * <ul>
 *   <li><b>canonical JSON</b> ({@link com.sj.audit.hash.CanonicalJson}) — one and only one byte
 ...
 *   <li><b>leaf commitment</b> ({@link com.sj.audit.hash.PayloadCommitments}) —
 ...
 *   <li><b>content hash</b> / <b>record hash</b> ({@link com.sj.audit.hash.AuditHasher}) — see that
 *       class. Content hash = "what the record says"; record hash = "the link to the record
 *       before".
 *   <li><b>domain separation</b> ({@link com.sj.audit.hash.Hashing}) — every multi-part hash input
