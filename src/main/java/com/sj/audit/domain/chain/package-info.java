 ...
 *
 * <ul>
 *   <li>{@link ChainAppender} — the <b>single writer</b>. Locks the
 ...
 *   <li>{@link ChainVerifier} — walks {@code seq} in order, recomputing each
 *       record's hashes and checking the links, and returns a {@link
 *       VerificationReport} naming the first {@link
 *       ViolationType} it finds (or {@code intact}).
 * </ul>
 *
 * <h2>Vocabulary</h2>
 *
